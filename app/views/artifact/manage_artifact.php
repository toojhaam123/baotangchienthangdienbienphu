                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <!-- Form thêm hiện vật -->
                                    <form action="?request=manage_artifact&modal_id=add_artifact" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group text-start">
                                            <label for="artifact_audio">Âm thanh hiện vật</label>
                                            <span>*<?php echo isset($errors['audio']) ? $errors['audio'] : ''; ?></span>
                                            <input type="file" class="form-control" name="artifact_audio" id="artifact_audio">
                                        </div>
                                        <div class="form-group text-start">
                                    ...
                                    if ($artifact['type'] == 'weapon') { ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <audio controls src="./public/uploads/audioArtifact/<?= $artifact['audio'] ?>"></audio>
                                                </td>
                                                <td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <img class="img-thumbnail" src="./public/uploads/imageArtifact/<?= $artifact['image'] ?>" alt="">
                                                    </div>
                                                    <div class="col-lg-9">
                                                        <audio controls src="./public/uploads/audioArtifact/<?= $artifact['audio'] ?>"></audio>
                                                    </div>
                                                ...
                                                <form action="?request=manage_artifact&modal_id=edit_artifact<?php echo $countId ?>&page=<?= $pageArtifact ?>" method="post" enctype="multipart/form-data">
                                                    <div class="form-group text-start">
                                                        <input type="hidden" name="old_image" value="<?= $artifact['image'] ?>">
                                                        <input type="hidden" name="old_audio" value="<?= $artifact['audio'] ?>">
                                                    </div>
                                                    <div class="form-group text-start">
                                                        <label for="artifact_img">Chọn ảnh mới</label>
                                                        <span>*<?php echo isset($errors['image']) ? $errors['image'] : ''; ?></span>
                                                        <input type="file" class="form-control" name="artifact_img" id="artifact_img">
                                                    </div>
                                                    <div class="form-group text-start">
                                                        <label for="artifact_audio">Chọn âm thanh mới</label>
                                                        <span>*<?php echo isset($errors['audio']) ? $errors['audio'] : ''; ?></span>
                                                        <input type="file" class="form-control" name="artifact_audio" id="artifact_audio">
                                                    </div>
                                                    <div class="form-group text-start">
