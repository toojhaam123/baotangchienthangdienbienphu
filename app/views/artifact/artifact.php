                ...
                <div class="modal-content">
                    ...
                    <div class="col-md-12 border-bottom mb-3">
                        ...
                        <div class="modal-body">
                            <img class=" mb-1 img-thumbnail" src="./public/uploads/imageArtifact/<?php echo $artifact['image'] ?>" alt="<?php echo $artifact['name'] ?>">
                    ...
                    <div class="comment">
                        ...
                        <form action="?request=artifact&modal_id=detail_artifact<?php echo $countId ?>&page=<?= $pageArtifact ?>" method="post">
