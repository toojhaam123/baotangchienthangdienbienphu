                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="col-md-12 border-bottom mb-3">
                                        ...
                                        <div class="modal-body">
                                            <img class="mb-1 card-img-top" src="./public/uploads/imageArtifact/<?php echo $newArtifact['image'] ?>"
                                                alt="<?php echo $newArtifact['name'] ?>" title="<?php echo $newArtifact['name'] ?>">
                                            <audio controls src="./public/uploads/audioArtifact/<?= $newArtifact['audio'] ?>"></audio>
                                            <div class="row">
                                    ...
                                    <div class="comment">
                                        ...
                                        <form action="?modal_id=detail_artifact<?php echo $countId ?>" method="post">
