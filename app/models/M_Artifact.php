...
class M_Artifact
{
    ...
    // Hàm thêm hiện vật
    public function createArtifact($name, $description, $type, $image, $audio)
    {
        // Câu lệnh SQL Insert
        $insertArtifact = "INSERT INTO artifacts (name, type, description, image, audio)
        VALUES (:name, :type, :description,  :image, :audio)";
    ...
    public function updateArtifact($name, $description, $type, $image, $audio, $artifactId)
    {

        // Câu lệnh SQL Insert
        $updateArtifact = "UPDATE artifacts SET name = :name, type = :type, description = :description, image = :image, audio = :audio
